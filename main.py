...
class App(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Numerical Integration Calculator v1.0")
    ...
    def _build(self):
        ...
        sub.pack(anchor="w")
        tk.Label(sub, text="Calculate definite integrals with multiple methods",
                 bg=BG, fg=DIM, font=("Segoe UI",9)).pack(side="left")
        tk.Label(sub, text="v1.0",
                 bg=BG, fg=PURPLE, font=("Segoe UI",9,"bold")).pack(side="left", padx=(8,0))
